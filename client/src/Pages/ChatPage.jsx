...
const ChatPage = () => {
	...
	const { messages, getMessages, subscribeToMessage, unsubscribeFromMessage } = useMessageStore();
	...
	}, [getMyMatches, authUser, getMessages, subscribeToMessage, unsubscribeFromMessage, id]);
...
if (isLoadingMyMatches || !Array.isArray(matches) || matches.length === 0) {
